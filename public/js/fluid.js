...
//Second attempt at modal with jQuery
//$('#loginSignUp').on('show.bs.modal', function (event) {
...
function liquidFillGaugeDefaultSettings() {
    return {
        ...
        textSize: 0.70, // The relative height of the text to display in the wave circle. 1 = 50%
